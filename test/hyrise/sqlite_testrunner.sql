-- The queries the hyrise SQLiteTestRunner runs against SQLite
-- (`resources/test_data/sqlite_testrunner_queries.sql` of https://github.com/hyrise/hyrise), one per
-- line and verbatim, save for the trailing `;` this parser insists on and which upstream omits here
-- and there.
